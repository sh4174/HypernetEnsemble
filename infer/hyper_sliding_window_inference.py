"""
Slider inference for hypernetwork with hyperparameters as additional inputs
Modified from sliding_window_inference implementation from the MONAI framework
https://docs.monai.io/en/latest/_modules/monai/inferers/utils.html#sliding_window_inference

Modification:
Made predictor to take hyper_input as additional inputs
seg_prob = predictor(window_data, hyper_input, *args, **kwargs).to(device)  # batched patch segmentation
...
def hyper_sliding_window_inference(
    inputs: torch.Tensor,
